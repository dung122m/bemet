...
@section('title')
      {{ $product->name  }}  - Bemet - Butcher & Meat 
                    ...
                    <div class="row">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane show active" id="itemOne-tab-pane" role="tabpanel" aria-labelledby="itemOne-tab" tabindex="0">
                                        <a href="uploads/product/{{ $product->image }}" class="popup-image">
                                            <img id="main-img" src="uploads/product/{{ $product->image }}" alt="{{ $product->name }}" style="width:75%">
                                        </a>
                                    </div>
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link "  >
                                            <img class="thumb-image" src="uploads/product/{{ $product->image }}" alt="" width="100px">
                                        </button>
                                    </li>
                                    @foreach ($product->images as $item)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" >
                                            <img class="thumb-image" src="uploads/product/{{ $item->image }}" alt="" width="100px">
                                        </button>
                                    </li>
                                    @endforeach
                        ...
                        <div class="col-lg-6">
                            <div class="shop-details-content">
                                ...
                                <span class=""><s>{{number_format( $product->price,0) }} VND</s> </span>
                                <h6 class="price">{{number_format( $product->sale_price,0) }} vnd</h6>
                            ...
                            @foreach ($relatedProduct as $item)
                                ...
                                <div class="product-item-three inner-product-item">
                                    <div class="product-thumb-three">
                                        <a href="shop-details.html"><img src="uploads/product/{{ $item->image }}" alt=""></a>
                                        <span class="batch">New<i class="fas fa-star"></i></span>
                                    </div>
                                    <div class="product-content-three">
                                        <a href="shop.html" class="tag">{{ $item->category->name }}</a>
                                        <h2 class="title"><a href="shop-details.html">{{ $item->name }}</a></h2>
                                        <small class=""><s>{{number_format( $item->price,0) }} VND</s> </small>
                                        <span class="price">{{number_format( $item->sale_price,0) }} vnd</span>

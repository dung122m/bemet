                                ...
                                <div class="features-item tg-motion-effects">
                                    <div class="features-content">
                                        ...
                                        <div class="favorite-icon">
                                            ...
                                            <a href="{{ route("cart.add",$item->id) }}"><i class="fas fa-shopping-cart fa-2x"></i></a>
                                        </div>
                                        @else
                                        <div class="favorite-icon">
                                                @if ($item->favorited)
                                                    <a href="{{ route("account.login") }}"><i class="fas fa-heart fa-2x" style="color: #f51414;"></i></a>
                                                @else
                                                <a href="{{ route("account.login") }}"><i class="far fa-heart fa-2x"></i></a>
                                                @endif
                                        ...
                                        <div class="favorite-icon">
                                            ...
                                            <a href="{{ route("account.login") }}"><i class="fas fa-shopping-cart fa-2x"></i></a>
                                        </div>
                                        @endif
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center mb-60">
                                ...
                                <h2 class="title">Our Sale Products</h2>
                            ...
                            <div class="col-88">
                                <div class="gallery-active">
                                    @foreach ($gallerys as $gallery)
                                        ...
                                        <a href="{{ route("home.product",$item->id) }}" class="popup-image"><img src="uploads/gallery/{{ $gallery->image }}" alt=""></a>
                                    </div>
                                    @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center mb-70">
                                <span class="sub-title">Organic Shop</span>
                                <h2 class="title">Our Feature Products</h2>
                                <div class="title-shape" data-background="uploads/images/title_shape.png"></div>
                            </div>
                        </div>
                    </div>
